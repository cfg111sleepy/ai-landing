        ...
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-12 text-center">
            ...
            <p className="text-lg text-indigo-200/65">
              Мы создаём инструменты, которые помогают руководителям выстраивать
              устойчивую и продуктивную рабочую среду — независимо от того, где
              находится команда. Решения для тех, кто понимает ценность стабильности
              и эффективности.
            </p>
          </div>
            ...
            <div className="flex justify-center pb-12 max-md:hidden md:pb-16">
              <div className="relative inline-flex flex-wrap justify-center rounded-full bg-gradient-to-r from-blue-900/60 via-blue-800/40 to-blue-900/60 shadow-lg p-1 border border-blue-700/40 backdrop-blur-md">
                ...
                >
                  <svg
                    className={`fill-current ${
                      category === 5 ? "text-blue-400" : "text-blue-300"
                    }`}
                    xmlns="http://www.w3.org/2000/svg"
                    width="18"
                    height={18}
